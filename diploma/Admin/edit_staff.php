<?php
	...
	mysqli_query($conn,"update staff set Name='$name',email='$email',password='$pass',Plaza_city='$city',Highway_No='$hno' where id='".$_GET['id']."'");	
...
<body>
   ...
   <label><b><?php echo @$err;?></b></label><br><br>
	...
	<input type="text" id="lname" value="<?php echo @$res['email'];?>" name="email" placeholder="Enter Email">
	<br>
	<label>Password</label><br>
	<input type="password" id="lname" value="<?php echo @$res['password'];?>" name="pass" placeholder="Enter Password">
	<br>
	<label>City </label><br>
	<input type="text" id="vno" value="<?php echo @$res['Plaza_city'];?>" name="city">
	<br>
	<label>Highway No. </label><br>
	<input type="text" id="vno" value="<?php echo @$res['Highway_No'];?>" name="hno">
	<br>
