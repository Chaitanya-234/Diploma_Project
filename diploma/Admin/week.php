...
$sql = "SELECT * FROM vechicle WHERE `date_time` >= DATE_SUB( CURDATE( ) ,INTERVAL 7 DAY ) ORDER BY id";
...
<body>
    ...
    $result1 = $mysqli->query("SELECT sum(tax) FROM vechicle  WHERE `date_time` >= DATE_SUB( CURDATE( ) ,INTERVAL 7 DAY )") or die(mysqli_error());
