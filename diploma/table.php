...
$sql = "SELECT * FROM vechicle WHERE TaxReceiver LIKE "."'".$_SESSION['user']."' ORDER BY id";
...
<body>
    ...
    $result1 = $mysqli->query("SELECT sum(tax) FROM vechicle WHERE TaxReceiver LIKE "."'".$_SESSION['user']."'") or die(mysqli_error());
    ...
    <div >    <input type="Button" class="back" name="" value="Back" onclick="back()">
        </div>
